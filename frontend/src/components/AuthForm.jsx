...
const AuthForm = ({ type }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (type === "signup") {
                ...
                // Set flag for new user setup
                localStorage.setItem("needsSetup", "true");

                navigate("/FreshSetup"); // Redirect to FreshSetup
            } else {
                ...
                // Ensure flag is removed for existing users
    ...
    const handleGoogleSignIn = async () => {
        try {
            ...
            // Extract isNewUser from additionalUserInfo
